...
/* convenience macros */
#define	NV_ALIGN(x)		(((u_long)(x) + 7ul) & ~7ul)
...
/* list management */
int nvlist_alloc(nvlist_t **, uint32_t, int);
...
uint32_t nvlist_nvflag(nvlist_t *);

int nvlist_xalloc(nvlist_t **, uint32_t, nv_alloc_t *);
...
int nvlist_add_byte_array(nvlist_t *, const char *, uchar_t *, uint32_t);
...
int nvlist_lookup_boolean_array(nvlist_t *, const char *,
    boolean_t **, uint32_t *);
int nvlist_lookup_byte_array(nvlist_t *, const char *, uchar_t **, uint32_t *);
...
int nvlist_lookup_int16_array(nvlist_t *, const char *, int16_t **, uint32_t *);
int nvlist_lookup_uint16_array(nvlist_t *, const char *, uint16_t **, uint32_t *);
int nvlist_lookup_int32_array(nvlist_t *, const char *, int32_t **, uint32_t *);
int nvlist_lookup_uint32_array(nvlist_t *, const char *, uint32_t **, uint32_t *);
int nvlist_lookup_int64_array(nvlist_t *, const char *, int64_t **, uint32_t *);
int nvlist_lookup_uint64_array(nvlist_t *, const char *, uint64_t **, uint32_t *);
int nvlist_lookup_string_array(nvlist_t *, const char *, char ***, uint32_t *);
...
int nvpair_value_byte_array(nvpair_t *, uchar_t **, uint32_t *);
int nvpair_value_int8_array(nvpair_t *, int8_t **, uint32_t *);
int nvpair_value_uint8_array(nvpair_t *, uint8_t **, uint32_t *);
int nvpair_value_int16_array(nvpair_t *, int16_t **, uint32_t *);
int nvpair_value_uint16_array(nvpair_t *, uint16_t **, uint32_t *);
int nvpair_value_int32_array(nvpair_t *, int32_t **, uint32_t *);
int nvpair_value_uint32_array(nvpair_t *, uint32_t **, uint32_t *);
int nvpair_value_int64_array(nvpair_t *, int64_t **, uint32_t *);
int nvpair_value_uint64_array(nvpair_t *, uint64_t **, uint32_t *);
int nvpair_value_string_array(nvpair_t *, char ***, uint32_t *);
int nvpair_value_nvlist_array(nvpair_t *, nvlist_t ***, uint32_t *);
...
void fnvlist_add_byte_array(nvlist_t *, const char *, uchar_t *, uint32_t);
...
void fnvlist_add_int16_array(nvlist_t *, const char *, int16_t *, uint32_t);
void fnvlist_add_uint16_array(nvlist_t *, const char *, uint16_t *, uint32_t);
void fnvlist_add_int32_array(nvlist_t *, const char *, int32_t *, uint32_t);
void fnvlist_add_uint32_array(nvlist_t *, const char *, uint32_t *, uint32_t);
void fnvlist_add_int64_array(nvlist_t *, const char *, int64_t *, uint32_t);
void fnvlist_add_uint64_array(nvlist_t *, const char *, uint64_t *, uint32_t);
void fnvlist_add_string_array(nvlist_t *, const char *, char * const *, uint32_t);
void fnvlist_add_nvlist_array(nvlist_t *, const char *, nvlist_t **, uint32_t);
